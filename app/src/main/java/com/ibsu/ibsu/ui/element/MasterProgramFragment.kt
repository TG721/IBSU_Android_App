...
import com.ibsu.ibsu.databinding.FragmentMasterProgramBinding
...
@AndroidEntryPoint
class MasterProgramFragment(val schoolValue: String?) :
    BaseFragment<FragmentMasterProgramBinding>(FragmentMasterProgramBinding::inflate) {
