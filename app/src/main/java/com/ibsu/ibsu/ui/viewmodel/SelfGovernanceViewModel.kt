...
class SelfGovernanceViewModel @Inject constructor(private val getSelfGovernanceUseCase: GetSelfGovernanceUseCase) : ViewModel(){
    private val _myState =
        MutableStateFlow<ResponseState<SelfGovernance>>(ResponseState.Empty()) //mutable state flow
    val myState: StateFlow<ResponseState<SelfGovernance>> = _myState //immutable state flow
